...
pub struct RepoSyncParser;
pub struct RepoListParser;
pub struct RepoStatusParser;
pub struct RepoBranchesParser;
pub struct RepoDiffParser;
pub struct RepoStartParser;
pub struct RepoCheckoutParser;
pub struct RepoForallParser;
pub struct RepoStageParser;
pub struct RepoInitParser;
pub struct RepoUploadParser;
