...
pub struct FossilDiffParser;
pub struct FossilLogParser;
pub struct FossilChangesParser;
pub struct FossilTimelineParser;
pub struct FossilUndoParser;
pub struct FossilStashParser;
pub struct FossilMergeParser;
...
fn parse_generic_diff_for_tool(
    ...
    for line in raw.lines() {
        ...
        // 法则 E: "Index: path" diff 头降维为 DIFF://path
