...
mod tests {
    ...
    fn generate_template_driven_showcase_report() {
        ...
        let cases = [
            ("case_001_simple_template.log", "简单模板"),
            ("case_002_error.log", "错误"),
            ("case_003_complex.log", "复杂"),
            ...
            ("case_010_react_jsx.log", "React JSX"),
            ("case_011_handlebars.log", "Handlebars"),
            ("case_012_ejs.log", "EJS"),
        ];

        let mut all_output = String::new();
        all_output.push_str(&"=".repeat(80));
        all_output.push_str("\n  Template Driven AI Compact Showcase\n");
        all_output.push_str(&"=".repeat(80));
        all_output.push_str("\n\n");
        ...
        std::fs::write(
            std::path::Path::new(env!("CARGO_MANIFEST_DIR"))
                .join("target")
                .join("template_driven_compact_showcase_report.txt"),
            &all_output,
        )
        .unwrap();
    }
