...
pub struct GlabMrListParser;
pub struct GlabMrViewParser;
pub struct GlabMrCreateParser;
pub struct GlabIssueListParser;
pub struct GlabIssueViewParser;
pub struct GlabIssueCreateParser;
