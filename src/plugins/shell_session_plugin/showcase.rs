...
mod tests {
    ...
    pub const SHOWCASE_CASES: &[(&str, &str)] = &[
        (
            "case_001_bash_success",
            "Bash success with command and empty prompt",
        ),
        (
            "case_002_bash_command_not_found",
        ...
        (
            "case_006_fish_unexpected_end",
            "Fish unexpected END loop error",
        ),
        (
            "case_007_powershell_success_table",
            "PowerShell successful output with table format",
        ),
        (
            "case_008_powershell_parser_error",
            "PowerShell ParserError exception",
        ),
        (
            "case_009_powershell_parameter_binding_exception",
        ...
        (
            "case_015_bash_env_secrets",
            "Bash env with sensitive secrets",
        ),
        ("case_016_bash_find_grep", "Bash find and grep pipeline"),
        (
            "case_017_bash_curl_tar",
            "Bash curl download and tar extraction",
        ),
        (
            "case_018_powershell_get_childitem",
            "PowerShell Get-ChildItem listing",
        ),
        (
            "case_019_powershell_invoke_webrequest",
            "PowerShell Invoke-WebRequest output",
        ),
        ...
        (
            "case_025_bash_chmod_chown",
            "Bash chmod and chown permission changes",
        ),
        ...
        (
            "case_030_bash_systemctl",
            "Bash systemctl systemd service control",
        ),
        ...
        (
            "case_037_bash_redirection",
            "Bash shell redirection operators",
        ),
        (
            "case_038_bash_env_prefix",
            "Bash env-prefix routing to dedicated tool",
        ),
        (
            "case_039_ps_get_process",
            "PowerShell Get-Process with Select-Object",
        ),
        ("case_040_ps_copy_item", "PowerShell Copy-Item file copy"),
        (
            "case_041_ps_where_object",
            "PowerShell Where-Object filter pipeline",
        ),
        (
            "case_042_ps_convertfrom_json",
            "PowerShell ConvertFrom-Json parse",
        ),
        ...
        (
            "case_048_bash_permission_denied",
            "Bash permission denied error",
        ),
        ("case_049_bash_syntax_error", "Bash syntax error"),
        (
            "case_050_ps_command_not_found",
            "PowerShell command not found",
        ),
        ("case_051_cmd_not_recognized", "CMD not recognized error"),
        (
            "case_052_bash_git",
            "Bash git routing boundary - handed off to git plugin",
        ),
        (
            "case_053_ps_cargo",
            "PowerShell cargo routing boundary - handed off to cargo plugin",
        ),
        (
            "case_054_bash_kubectl",
            "Bash kubectl routing boundary - handed off to kubectl plugin",
        ),
        (
            "case_055_cmd_mvn",
            "CMD mvn routing boundary - handed off to mvn plugin",
        ),
        (
            "case_056_bash_docker",
            "Bash docker routing boundary - handed off to docker plugin",
        ),
        (
            "case_057_bash_npm",
            "Bash npm routing boundary - handed off to npm plugin",
        ),
        (
            "case_058_bash_pytest",
            "Bash pytest routing boundary - handed off to pytest plugin",
        ),
        (
            "case_059_bash_terraform",
            "Bash terraform routing boundary - handed off to terraform plugin",
        ),
        (
            "case_060_ps_helm",
            "PowerShell helm routing boundary - handed off to helm plugin",
        ),
        ...
        (
            "case_079_ps_remove_item",
            "PowerShell Remove-Item recursive deletion",
        ),
        ("case_080_bash_wget", "Bash wget file download"),
    ];

    /// 生成 Shell 会话插件全景 showcase 报告：遍历样例，输出原文/压缩行数字节与压缩率。
    #[test]
